...
function Home() {
  ...
  return (
    <Container className="py-5">
      ...
      <Row className="mb-5 justify-content-center align-items-center" style={{ minHeight: '40vh' }}>
        ...
        {/* right column intentionally left out; registration moved to navbar modal */}
      </Row>
